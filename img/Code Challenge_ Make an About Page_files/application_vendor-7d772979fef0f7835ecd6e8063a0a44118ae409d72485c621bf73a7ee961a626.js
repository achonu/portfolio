"function" != typeof Function.prototype.bind && (Function.prototype.bind = function(e) {
  ...
  e.position = {
    ...
    v.left += o[0], v.top += o[1], this.each(function() {
      var r, u, c = e(this), d = c.outerWidth(), h = c.outerHeight(), p = n(this, "marginLeft"), y = n(this, "marginTop"), C = d + p + n(this, "marginRight") + w.width, k = h + y + n(this, "marginBottom") + w.height, T = e.extend({}, v), M = i(S.my, c.outerWidth(), c.outerHeight());
  ...
  var v = function(e, t) {
    ...
    return i ? e : void 0;
  }, _ = Math.pow(2, 53) - 1, S = b("length"), C = function(e) {
    var t = S(e);
    return "number" == typeof t && t >= 0 && t <= _;
  };
  f.each = f.forEach = function(e, t, i) {
    var n, r;
    if (t = m(t, i), C(e)) for (n = 0, r = e.length; n < r; n++) t(e[n], n, e); else {
      var o = f.keys(e);
    ...
    t = g(t, i);
    for (var n = !C(e) && f.keys(e), r = (n || e).length, o = Array(r), s = 0; s < r; s++) {
      var a = n ? n[s] : s;
      o[s] = t(e[a], a, e);
    }
    return o;
  ...
  var k = function(e) {
    var t = function(t, i, n, r) {
      var o = !C(t) && f.keys(t), s = (o || t).length, a = e > 0 ? 0 : s - 1;
  ...
  f.reduce = f.foldl = f.inject = k(1), f.reduceRight = f.foldr = k(-1), f.find = f.detect = function(e, t, i) {
    var n = (C(e) ? f.findIndex : f.findKey)(e, t, i);
    ...
    t = g(t, i);
    for (var n = !C(e) && f.keys(e), r = (n || e).length, o = 0; o < r; o++) {
      var s = n ? n[o] : o;
    ...
    return C(e) || (e = f.values(e)), ("number" != typeof i || n) && (i = 0), f.indexOf(e, t, i) >= 0;
    ...
    if (null == t || "number" == typeof t && "object" != typeof e[0] && null != e) for (var a = 0, l = (e = C(e) ? e : f.values(e)).length; a < l; a++) null != (n = e[a]) && n > o && (o = n); else t = g(t, i), 
    ...
    if (null == t || i) return C(e) || (e = f.values(e)), e[f.random(e.length - 1)];
    var n = C(e) ? f.clone(e) : f.values(e), r = S(n);
  ...
  f.toArray = function(e) {
    return e ? f.isArray(e) ? s.call(e) : f.isString(e) ? e.match(M) : C(e) ? f.map(e, f.identity) : f.values(e) : [];
  }, f.size = function(e) {
    return null == e ? 0 : C(e) ? e.length : f.keys(e).length;
  ...
  var D = function(e, t, i, n) {
    for (var r = (n = n || []).length, o = 0, s = S(e); o < s; o++) {
      var a = e[o];
      if (C(a) && (f.isArray(a) || f.isArguments(a))) if (t) for (var l = 0, u = a.length; l < u; ) n[r++] = a[l++]; else D(a, t, i, n), 
  ...
  f.flatten = function(e, t) {
    ...
    for (var t = [], i = arguments.length, n = 0, r = S(e); n < r; n++) {
      var o = e[n];
      if (!f.contains(t, o)) {
        var s;
    ...
    for (var t = e && f.max(e, S).length || 0, i = Array(t), n = 0; n < t; n++) i[n] = f.pluck(e, n);
    return i;
  }, f.zip = v(f.unzip), f.object = function(e, t) {
    for (var i = {}, n = 0, r = S(e); n < r; n++) t ? i[e[n]] = t[n] : i[e[n][0]] = e[n][1];
    return i;
  };
  var A = function(e) {
    return function(t, i, n) {
      i = g(i, n);
      for (var r = S(t), o = e > 0 ? 0 : r - 1; o >= 0 && o < r; o += e) if (i(t[o], o, t)) return o;
      return -1;
    };
  };
  f.findIndex = A(1), f.findLastIndex = A(-1), f.sortedIndex = function(e, t, i, n) {
    for (var r = (i = g(i, n, 1))(t), o = 0, s = S(e); o < s; ) {
  ...
  f.pick = v(function(e, t) {
    ...
    return null == e || (C(e) && (f.isArray(e) || f.isString(e) || f.isArguments(e)) ? 0 === e.length : 0 === f.keys(e).length);
  ...
  m() && !g() && (C = !1), t.uniform = {
    ...
    var n = this;
    return i = t.extend({}, t.uniform.defaults, i), k || (k = !0, f() && (C = !1)), 
  ...
  var i = {
    ...
    function v() {
      ...
      e > -1 && (j = O.slice(e + 1).join(""), j = r.rtrim(j), t.defer(t.bind(S, this, j)));
    }
    function y(e) {
    ...
    return o = e.extend(!0, {}, n, o), {
      init: function(e) {
        k = e, s(), a(), l(), C(), o.prefillMention && h(o.prefillMention);
      },
      val: function(e) {
        if (t.isFunction(e)) {
  ...
  return function e(t, i, n) {
    ...
    4: [ function(e, t) {
      ...
      for (var k in S) C[JSON.stringify(S[k])] = k;
    }, {} ],
    5: [ function(e, t) {
        ...
        e.controllers.bar = e.DatasetController.extend({
          ...
          calculateBarIndexPixels: function(e, t, i) {
            ...
            l = 1), {
              ...
              ratio: l,
              start: d - a / 2
            }), S = this.getStackIndex(e, this.getMeta().stack), C = _.start + _.chunk * S + _.chunk / 2, k = Math.min(r.valueOrDefault(w.maxBarThickness, 1 / 0), _.chunk * _.ratio);
            return {
              base: C - k / 2,
              head: C + k / 2,
              center: C,
      ...
      i._set("doughnut", {
        ...
        e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
          ...
          update: function(e) {
            ...
            if (f < 2 * Math.PI) {
              var p = o.rotation % (2 * Math.PI), m = (p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0)) + f, g = Math.cos(p), v = Math.sin(p), y = Math.cos(m), b = Math.sin(m), x = p <= 0 && m >= 0 || p <= 2 * Math.PI && 2 * Math.PI <= m, w = p <= .5 * Math.PI && .5 * Math.PI <= m || p <= 2.5 * Math.PI && 2.5 * Math.PI <= m, _ = p <= -Math.PI && -Math.PI <= m || p <= Math.PI && Math.PI <= m, S = p <= .5 * -Math.PI && .5 * -Math.PI <= m || p <= 1.5 * Math.PI && 1.5 * Math.PI <= m, C = h / 100, k = _ ? -1 : Math.min(g * (g < 0 ? 1 : C), y * (y < 0 ? 1 : C)), T = S ? -1 : Math.min(v * (v < 0 ? 1 : C), b * (b < 0 ? 1 : C)), M = x ? 1 : Math.max(g * (g > 0 ? 1 : C), y * (y > 0 ? 1 : C)), D = w ? 1 : Math.max(v * (v > 0 ? 1 : C), b * (b > 0 ? 1 : C)), A = .5 * (M - k), P = .5 * (D - T);
      ...
      t.exports = {
        ...
        update: function(e, t, o) {
          ...
          if (e) {
            ...
            var b = t - c - d, x = o - h - f, w = x / 2, _ = (t - b / 2) / (p.length + m.length), S = (o - w) / (g.length + v.length), C = b, k = x, T = [];
            r.each(p.concat(m, g, v), function(e) {
              var t, i = e.isHorizontal();
              i ? (t = e.update(e.fullWidth ? b : C, S), k -= t.height) : (t = e.update(_, k), 
              C -= t.width), T.push({
                horizontal: i,
                minSize: t,
                box: e
            ...
            var R = c + O, H = h + N;
            r.each(p.concat(g), a), R += C, H += k, r.each(m, a), r.each(v, a), e.chartArea = {
              left: I,
              top: E,
              right: I + C,
              bottom: E + k
              ...
              t.bottom = e.chartArea.bottom, t.update(C, k);
            });
          }
        }
      };
          ...
          fit: function() {
            ...
            if (u.display && h) {
              ...
              if (f) {
                ...
                var C = t(e.ctx, r[0], p.font), k = t(e.ctx, r[r.length - 1], p.font);
                0 !== e.labelRotation ? (e.paddingLeft = "bottom" === o.position ? _ * C + 3 : _ * b + 3, 
                e.paddingRight = "bottom" === o.position ? _ * b + 3 : _ * k + 3) : (e.paddingLeft = C / 2 + 3, 
            ...
            if (i.display) {
              ...
              if (s.each(g, function(r, o) {
                if (!s.isNullOrUndef(r.label)) {
                  var a, l, d, f, v, y, b, x, _, S, C, j, E, F, O = r.label;
                  ...
                  if (m) {
                    ...
                    v = b = _ = C = H, y = P, x = I, S = e.top, j = e.bottom + M;
                  } else {
                    ...
                    v = D, b = A, _ = e.left, C = e.right + M, y = x = S = j = $;
                  }
                  T.push({
                    tx1: v,
                    ty1: y,
                ...
                var j, E, F = 0, O = l(f) / 2;
                if (m) j = t.left + (t.right - t.left) / 2, E = "bottom" === i.position ? t.bottom - O - C.bottom : t.top + O + C.top; else {
                  var N = "left" === i.position;
                  j = N ? t.left + O + C.top : t.right - O - C.top, E = t.top + (t.bottom - t.top) / 2, 
    ...
    35: [ function(e, t) {
      ...
      i._set("global", {
        ...
        e.Tooltip = n.extend({
          ...
          update: function(t) {
            var i, n, o, a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, S, C = this, k = C._options, T = C._model, M = C._model = s(k), D = C._active, A = C._data, P = {
              xAlign: T.xAlign,
              yAlign: T.yAlign
            }, I = {
              x: T.x,
            ...
            if (D.length) {
              M.opacity = 1;
              var F = [], O = [];
              E = e.Tooltip.positioners[k.position].call(C, D, C._eventPosition);
              var N = [];
              ...
              k.filter && (N = N.filter(function(e) {
                ...
                F.push(k.callbacks.labelColor.call(C, e, C._chart)), O.push(k.callbacks.labelTextColor.call(C, e, C._chart));
              }), M.title = C.getTitle(N, A), M.beforeBody = C.getBeforeBody(N, A), M.body = C.getBody(N, A), 
              M.afterBody = C.getAfterBody(N, A), M.footer = C.getFooter(N, A), M.x = Math.round(E.x), 
              ...
              }(this, M)), o = M, a = j, l = P, u = C._chart, c = o.x, d = o.y, h = o.caretSize, 
            ...
            M.height = j.height, M.caretX = E.x, M.caretY = E.y, C._model = M, t && k.custom && k.custom.call(C, M), 
            C;
          },
        ...
        draw: function() {
          ...
          if (t.display) {
            ...
            s.each(e.legendItems, function(i, r) {
              var f, m, g, v, _, S = d.measureText(i.text).width, C = y + p / 2 + S, k = c.x, T = c.y;
              x ? k + C >= l && (T = c.y += w, c.line++, k = c.x = e.left + (l - u[c.line]) / 2) : T + w > e.bottom && (k = c.x = k + e.columnWidths[c.line] + n.padding, 
              ...
              }(k, T, i), b[r].left = k, b[r].top = T, f = i, m = S, v = y + (g = p / 2) + k, 
    ...
    58: [ function(e, t) {
      ...
      t.exports = function(e) {
        var t = e.Scale.extend({
          ...
          buildTicks: function() {
            var e, t, i, n, c, d, h, f, g, v, y, b, x = this, w = x.min, _ = x.max, S = x.options, C = S.time, k = [], T = [];
            switch (S.ticks.source) {
             ...
             case "auto":
             default:
              k = l(w, _, x.getLabelCapacity(w), S);
            }
            for ("ticks" === S.bounds && k.length && (w = k[0], _ = k[k.length - 1]), w = s(C.min, x) || w, 
            _ = s(C.max, x) || _, e = 0, t = k.length; e < t; ++e) (i = k[e]) >= w && i <= _ && T.push(i);
            ...
            }(T, C.minUnit, x.min, x.max), x._majorUnit = a(x._unit), x._table = function(e, t, i) {
...
Zepto.fn.outerWidth = function(e) {
  ...
  var t = e.tablesorter = {
    ...
    buildCache: function(i, n, r) {
      var o, s, a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, S, C, k, T, M = i.table, D = i.parsers;
      ...
      for (i.debug && (g = new Date()), i.showProcessing && t.isProcessing(M, !0), c = 0; c < d.length; c++) {
        ...
        p = h.children("th, td"), k = b.child.length, b.child[k] = [], _ = 0, C = i.columns, 
        u = 0; u < C; u++) (m = p[u]) && (b.child[k][u] = t.getParsedText(i, m, u), (w = p[u].colSpan - 1) > 0 && (_ += w, 
        C += w)), _++; else {
          for (y.$row = h, y.order = l, _ = 0, C = i.columns, u = 0; u < C; ++u) {
            if ((m = h[0].cells[u]) && _ < i.columns && (!(S = "undefined" != typeof D[_]) && i.debug && console.warn("No parser found for row: " + l + ", column: " + u + '; cell containing: "' + e(m).text() + '"; does it have a header?'), 
  ...
  return function(e, t, i) {
    ...
    t.themes = {
      ...
      format: function(i, n, r) {
        var o, s, a, l, u, c, d, h, f, p, m, g, v, y = t.themes, b = n.$table.add(e(n.namespace + "_extra_table")), x = n.$headers.add(e(n.namespace + "_extra_headers")), w = n.theme || "jui", _ = y[w] || {}, S = e.trim([ _.sortNone, _.sortDesc, _.sortAsc, _.active ].join(" ")), C = e.trim([ _.iconSortNone, _.iconSortDesc, _.iconSortAsc ].join(" "));
    ...
    e.extend(r, {
      ...
      findRows: function(r, o, s) {
        if (!t.equalFilters(r.config, r.config.lastSearch, s) && r.config.widgetOptions.filter_initialized) {
          var a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, S, C, k, T, M, D, A, P = e.extend([], o), I = r.config, j = I.widgetOptions, E = {
            anyMatch: !1,
            filters: o,
            filter_regexCache: []
          }, F = {
          ...
          I.filteredRows = 0, I.totalRows = 0, s = P || [], f = 0; f < I.$tbodies.length; f++) {
            ...
            c = e(e.map(l, function(e) {
              ...
              if (C = j.filter_searchFiltered, v = I.lastSearch || I.$table.data("lastSearch") || [], 
              ...
              for (S = c.not("." + j.filter_filteredRow).length, C && 0 === S && (C = !1), I.debug && console.log("Filter: Searching through " + (C && S < a ? S : "all") + " rows"), 
              ...
              C = !1), E.iAnyMatchFilter = j.filter_ignoreCase && I.ignoreCase ? E.anyMatchFilter.toLowerCase() : E.anyMatchFilter), 
    ...
    e.extend(n.css, {
      ...
      format: function(r, o, s) {
        if (!(o.$table.hasClass("hasStickyHeaders") || e.inArray("filter", o.widgets) >= 0 && !o.$table.hasClass("hasFilters"))) {
          var a, l, u, c, d = o.$table, h = e(s.stickyHeaders_attachTo), f = o.namespace + "stickyheaders ", p = e(s.stickyHeaders_yScroll || s.stickyHeaders_attachTo || t), m = e(s.stickyHeaders_xScroll || s.stickyHeaders_attachTo || t), g = d.children("thead:first").children("tr").not(".sticky-false").children(), v = d.children("tfoot"), y = i(o, s), b = d.parent().closest("." + n.css.table).hasClass("hasStickyHeaders") ? d.parent().closest("table.tablesorter")[0].config.widgetOptions.$sticky.parent() : [], x = b.length ? b.height() : 0, w = s.$sticky = d.clone().addClass("containsStickyHeaders " + n.css.sticky + " " + s.stickyHeaders + " " + o.namespace.slice(1) + "_extra_table").wrap('<div class="' + n.css.stickyWrap + '">'), _ = w.parent().addClass(n.css.stickyHide).css({
          ...
          }), S = w.children("thead:first"), C = "", k = function(e, i) {
            ...
            if (d.is(":visible")) {
              ...
              var r = d.offset(), a = i(o, s), l = e.isWindow(p[0]), u = e.isWindow(m[0]), c = h.length ? l ? p.scrollTop() : p.offset().top : p.scrollTop(), f = s.stickyHeaders_includeCaption ? 0 : d.children("caption").height() || 0, g = c + a + x - f, y = d.height() - (_.height() + (v.height() || 0)) - f, w = g > r.top && g < r.top + y ? "visible" : "hidden", S = {
                visibility: w
              };
              h.length && (S.top = l ? g - h.offset().top : h.scrollTop()), u && (S.left = d.offset().left - parseInt(d.css("margin-left"), 10) - m.scrollLeft()), 
              S.top = (S.top || 0) + a + x, _.removeClass(n.css.stickyVis + " " + n.css.stickyHide).addClass("visible" === w ? n.css.stickyVis : n.css.stickyHide).css(S), 
              (w !== C || t) && (T(), C = w);
            }
          };
...
//# sourceMappingURL=/assets/maps/application_vendor-5548bc02b11bd5aeed4713a2ba17ea55971e84ce82d30b67d27ee0fda58092bb.js.map
